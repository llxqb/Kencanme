 ...
 */
public class RecommendUserAlbumAdapter extends BaseQuickAdapter<UserInfoAlbumResponse.DataBean, BaseViewHolder> {

    private ImageLoaderHelper mImageLoaderHelper;
    private Context mContext;

    public RecommendUserAlbumAdapter(Context context, @Nullable List<UserInfoAlbumResponse.DataBean> data, ImageLoaderHelper imageLoaderHelper) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, UserInfoAlbumResponse.DataBean item) {
