 ...
 */
@PerActivity
@Component(dependencies = AppComponent.class,modules = {RechargeBeansModule.class, ActivityModule.class})
public interface RechargeComponent extends ActivityComponent {
